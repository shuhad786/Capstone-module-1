...
for (let i = 0; i < guestsArr.length; i += 1) {
  ...
  guestSpeaker.appendChild(container1).appendChild(card1).appendChild(image);
  guestSpeaker.appendChild(container1).appendChild(card1).appendChild(card2).appendChild(nameElement);
  guestSpeaker.appendChild(container1).appendChild(card1).appendChild(card2).appendChild(title);
  guestSpeaker.appendChild(container1).appendChild(card1).appendChild(card2).appendChild(bio);
}
...
for (let i = 0; i < MguestsArr.length; i += 1) {
  ...
  MguestSpeaker.appendChild(container2).appendChild(card3).appendChild(image);
  MguestSpeaker.appendChild(container2).appendChild(card3).appendChild(card4).appendChild(nameElement);
  MguestSpeaker.appendChild(container2).appendChild(card3).appendChild(card4).appendChild(title);
  MguestSpeaker.appendChild(container2).appendChild(card3).appendChild(card4).appendChild(bio);
}
